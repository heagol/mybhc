...
<body>
	...
	<div class="content">
		<h1>삭제하기</h1>
		<form name="stockDeleteForm" action="admin_stock_delete_check.do" method="post">
			...
			<ul>
				...
				<li>
					...
					<a href="admin_stock_content.do?mid=${mid }"><button type="button" class="btn_style">이전페이지</button></a>
